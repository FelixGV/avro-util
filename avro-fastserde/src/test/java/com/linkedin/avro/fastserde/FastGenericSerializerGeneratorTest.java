...
public class FastGenericSerializerGeneratorTest {
  ...
  @Test(groups = {"serializationTest"})
  public void shouldReadArrayOfBoolean() {
    // given
  ...
  @Test(groups = {"serializationTest"})
  public void shouldReadArrayOfDouble() {
    // given
  ...
  @Test(groups = {"serializationTest"})
  public void shouldReadArrayOfFloats() {
    // given
  ...
  @Test(groups = {"serializationTest"})
  public void shouldReadArrayOfInts() {
    // given
  ...
  @Test(groups = {"serializationTest"})
  public void shouldReadArrayOfLongs() {
    // given
